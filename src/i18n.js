...
export const copy = {
  pt: {
    ...
    projects:[
      ...
      {type:"Análise documental em escala", title:"Triagem de retenções em notas", metric:"100% de acerto no XML", detail:"nos 6 layouts testados, incluindo MEI, nota cancelada, multi-serviço e tag fora de ordem", text:"Lê o XML da nota sempre que ele existe e é legítimo: nas 500 notas de teste, acertou todos os campos nos seis layouts. Uma verificação de procedência recusa XML gerado a partir de PDF, e não é preciosismo: na base real 100% dos XMLs eram conversão, 72% deles sem nenhum valor dentro. Esses caem no PDF lido por geometria, que acerta o número em 89,5% das notas contra 1,3% do XML convertido.", stack:["Python","XML NFS-e","PyMuPDF","PySide6"]},
  ...
  en: {
    ...
    projects:[
      ...
      {type:"Document analysis at scale", title:"Withholding triage on invoices", metric:"100% accuracy on XML", detail:"across the 6 layouts tested, including cancelled, multi-service and out-of-order tags", text:"Reads the invoice XML whenever it exists and is genuine: across 500 test invoices it got every field right in all six layouts. A provenance check rejects any XML generated from a PDF, and that is not fussiness: in the real base 100% of the XMLs were conversions, 72% of them with no values inside at all. Those fall back to the PDF read by geometry, which gets the invoice number right on 89.5% of notes against 1.3% for the converted XML.", stack:["Python","XML NFS-e","PyMuPDF","PySide6"]},
