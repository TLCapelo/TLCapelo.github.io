...
export const copy = {
  pt: {
    ...
    roles:[
      ...
      {period:"2025 — 2026", place:"1 ano e 5 meses", role:"Analista de BI", org:"EBMQUINTTO", text:"Estruturei o setor de Business Intelligence: extração e tratamento de dados via API e Excel, modelagem, definição de indicadores e dashboards em Power BI para apoiar a decisão de clientes de alto ticket.", tags:["Power BI","SQL","APIs","KPIs","Modelagem"]},
  ...
  en: {
    ...
    roles:[
      ...
      {period:"2025 — 2026", place:"1 year and 5 months", role:"BI Analyst", org:"EBMQUINTTO", text:"I built the Business Intelligence practice from scratch: data extraction and cleaning through APIs and Excel, modeling, KPI definition and Power BI dashboards to support decisions for high-ticket clients.", tags:["Power BI","SQL","APIs","KPIs","Modeling"]},
